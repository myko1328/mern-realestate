...
export default function SearchFeat() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setSidebardata({
        ...
        parking: StringToBoolean(parkingFromUrl ?? ""),
        furnished: StringToBoolean(furnishedFromUrl ?? ""),
        offer: StringToBoolean(offerFromUrl ?? ""),
  ...
  const handleChange = (e: any) => {
    ...
    if (
      ...
      setSidebardata({
        ...sidebardata,
        [e.target.id]: StringToBoolean(e.target.checked),
      });
    }
